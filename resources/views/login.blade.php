...
<head>
    ...
    <title>Masuk ke CourseApp</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-serene-200/50">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-serene-600 text-sm mt-2">Masuk untuk melanjutkan belajar</p>
            </div>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between text-sm">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 text-serene-600 rounded focus:ring-serene-500">
                        <span class="text-gray-600">Ingat saya</span>
                    </label>
                    <a href="#" class="text-serene-600 hover:text-serene-700 font-medium transition">Lupa password?</a>
                </div>
            ...
            <p class="text-center mt-8 text-sm text-gray-600">
                Belum punya akun? 
                <a href="{{ route('register') }}" class="font-bold text-serene-600 hover:text-serene-700 transition">
                    Daftar di sini
                </a>
            </p>
        </div>
